...
const ENGLISH_STORIES = [
  {
    ...
    moral: "Hard work and careful planning are more valuable than taking shortcuts.",
  ...
  },
  {
    ...
    moral: "A peaceful bedtime routine helps us feel safe and ready for sleep.",
  ...
  },
  {
    ...
    moral: "Curiosity and friendship help us discover the beauty and wonder in the world around us.",
  ...
  },
  {
    ...
    moral: "Be cautious with strangers and always listen to your instincts when something feels wrong.",
  ...
  },
  {
    ...
    moral: "The world is full of amazing things waiting to be discovered when we're brave enough to explore.",
  ...
  },
  {
    ...
    moral: "Friends of all sizes can come together to create joy and lasting memories.",
