...
async function main() {
  console.log("\n🇫🇷 SESSION 2A: French Classics Part 1 (Stories 1-15) 🇫🇷\n");

  const batch = frenchClassics.slice(0, 15);
  let successCount = 0;
  ...
  console.log(`\n✨ Session 2A Complete: ${successCount}/15 French stories saved ✨\n`);
}
