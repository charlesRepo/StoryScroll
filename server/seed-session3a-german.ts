...
async function main() {
  console.log("\n🇩🇪 SESSION 3A: German Classics Part 1 (Stories 1-15) 🇩🇪\n");

  const batch = germanClassics.slice(0, 15);
  let successCount = 0;
  ...
  console.log(`\n✨ Session 3A Complete: ${successCount}/15 German stories saved ✨\n`);
}
