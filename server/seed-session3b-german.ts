...
async function main() {
  console.log("\n🇩🇪 SESSION 3B: German Classics Part 2 (Stories 16-30) 🇩🇪\n");

  const batch = germanClassics.slice(15, 30);
  let successCount = 0;
  ...
  console.log(`\n✨ Session 3B Complete: ${successCount}/15 German stories saved ✨`);
  console.log(`📊 Total German classics: 30/30 complete! ✨\n`);
}
