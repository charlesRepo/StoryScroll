...
async function main() {
  console.log("\n🇫🇷 SESSION 2B: French Classics Part 2 (Stories 16-30) 🇫🇷\n");

  const batch = frenchClassics.slice(15, 30);
  let successCount = 0;
  ...
  console.log(`\n✨ Session 2B Complete: ${successCount}/15 French stories saved ✨`);
  console.log(`📊 Total French classics: 30/30 complete! ✨\n`);
}
