...
async function main() {
  console.log("\n🌙 SESSION 1B: English Classics Part 2 (Stories 16-30) 🌙\n");

  const batch = englishClassics.slice(15, 30);
  let successCount = 0;
  ...
  console.log(`\n✨ Session 1B Complete: ${successCount}/15 stories saved ✨`);
  console.log(`📊 Total English classics: 30/30 complete! ✨\n`);
}
